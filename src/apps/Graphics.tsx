...
import { graphics } from "../data/data";
  ...
  return (
    <section className="pb-10">
      ...
      <div className="mt-14 flex gap-5">
        ...
        <Link
          to="/app"
          className="bg-appDesign bg-cover bg-no-repeat relative w-full h-40 sm:h-[155px] flex flex-col justify-center items-center text-white mt-1"
        >
          <div className="overlay absolute top-0 w-full h-full bg-[#E7816B] opacity-50"></div>
          <div className="relative z-50">
