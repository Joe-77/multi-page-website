  ...
  return (
    <section>
      {country.map((e: any , id : number) => (
        ...
        >
          <div className="bg-[#FDF3F0] flex-1 flex items-center px-10 h-48 sm:h-80">
            <div className="h-48 sm:h-80 flex flex-col justify-center ">
              ...
              <div className="flex gap-10 mt-5 relative">
                ...
                <div className="w-1/2">
                  ...
                  <p className="text-xs leading-6">
                    P : <span className="text-[10px]">{e.phone}</span>
                  </p>
                  <p className="text-xs leading-6">
                    M : <span className="text-[10px]">{e.mail}</span>
                  </p>
                </div>
              </div>
            </div>
