  ...
  return (
    <footer className="bg-black mt-40 text-white pt-7 relative px-4 lg:px-0">
      ...
      <div className="container m-auto px-4 sm:px-0 pt-28 pb-5 sm:pt-14">
        ...
        <div className="flex items-end justify-between mt-5 pb-5">
          <div>
            <p className="text-[10px] sm:text-xs leading-6 text-gray-500">
              Designo Central Office <br /> 3886 Wellington Street
              <br /> Toronto, Ontario M9C 3J5
            </p>
          </div>
          <div className="text-[10px] sm:text-xs flex flex-col gap-2 text-gray-500 mb-2">
          ...
          <div className="flex items-center gap-3 mb-2">
            <span className="text-lg sm:text-2xl text-orange-500 duration-500 hover:text-orange-800 w-fit cursor-pointer">
              <FaFacebookF />
            </span>
            <span className="text-lg sm:text-2xl text-orange-500 duration-500 hover:text-orange-800 w-fit cursor-pointer">
              <FaYoutube />
